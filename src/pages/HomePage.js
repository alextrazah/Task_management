...
import graveyard_dashboard from "./dashboard/graveyard_dashboard";
...
const RouteWithLoader = ({ component: Component, ...rest }) => {
  ...
  return (
     <Route  render={props => ( <> <Preloader show={loaded ? false : true} /> <Component {...props} /> </> ) } />
...
export default function Myroutes () {
  return (
  <>
    {decoded !== null && decoded.role === "user" ? (
      <Switch>
        <Redirect path="/signin" to="/dashboard/overview" />
        <RouteWithLoader
          exact
